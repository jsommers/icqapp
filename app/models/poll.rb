class Poll < ApplicationRecord
  ...
  def activate_question
    pr = self.new_response
    broadcast_replace_to 'active_question_channel', partial: 'courses/activequestion', target: 'activequestion', locals: { course: self.question.course, question: self.question, poll: self, poll_response: pr, activepoll: true }
  end
